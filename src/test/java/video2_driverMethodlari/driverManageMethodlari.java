...
public class driverManageMethodlari {
    public static void main(String[] args) {
       ...
       // 1-A driver.manage().window().getSize()== > icinde oldugu sayfanin lpixel olarak okculaerini veriri
        System.out.println(driver.manage().window().getSize());

       //1-B driver.manage().window().getPosition();==> icinde oldugu sayfanin pixel olarak sonucunu dondurur
        System.out.println(driver.manage().window().getPosition());

       // 1-C driver.manage().window().setPosition(new Point(15,15));
        // icinde oldugu sayfanin sol alt kosesini bizim yazacagimiz pixsel naktasina tasir//
