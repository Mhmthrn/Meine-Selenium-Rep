...
public class C2_AssertionMethodlariIleTest {
    ...
    public void test01() {
        ...
        int aliYas=56; //Assert.assertFalse(aliYas>ememklilikYasi);
        int veliYas=68;//Assert.assertTrue(veliYas>emeklikikYasi);
        int emeklilikYasi=65;//Assert.assertEquals(65,emeklilikYasi);
